...
<div class="container">
	...
	} elseif ($ref == 'http://localhost/~tylerppp/student-db/teachers.php') {
		echo '<a href="teachers.php"><div class="glyphicon glyphicon-arrow-left"></div>&nbsp;Create Another Teacher</a>';
	} elseif ($ref == 'http://localhost/~tylerppp/student-db/classes.php') {
		echo '<a href="classes.php"><div class="glyphicon glyphicon-arrow-left"></div>&nbsp;Create Another Class</a>';
